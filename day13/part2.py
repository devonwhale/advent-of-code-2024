...
class Machine:
    def __init__(self, a, b, target_x, target_y):
        self.a = a
        self.b = b
        self.target_x = target_x + 10000000000000
        self.target_y = target_y + 10000000000000
...
for machine in machines:
    ...
    a_multiplier = Symbol('m', positive=True, real=True)
    b_multiplier = Symbol('n', positive=True, real=True)
